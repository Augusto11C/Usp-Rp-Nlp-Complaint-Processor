...
#Implementação da variação do algoritmo do restaurante chines
    ...
    def prepara_os_ingredientes(self):
        ...
        self.model = KeyedVectors.load_word2vec_format("../skip_s50/skip_s50.txt")
    ...
    def empratar(self, limite_de_clusters = np.inf):
        ...
        for i, vetores in enumerate(self.lista_de_vetores):
            ...
            print(p)
            print("n_cluster< len")
            print(n_cluster < len(self.lista_de_clusters))
            print("r<p")
            print(r < p )
            print(r < p and n_cluster < limite_de_clusters)
